...
<blockquote>
  <img class="link-icon" src="/favicon-32x32.png" alt="MS"><i><a target="_blank" href="https://mediasuite.clariah.nl/tool/single-search?queryId=649782d5-9e37-492e-b551-051389e68098">See the metadata</a> for all the DWDD programmes in the Media Suite (if you have a login then you can also watch the programmes).</i>
</blockquote>
...
<br>
<img class="link-icon" src="/favicon-32x32.png" alt="MS"><i><a target="_blank" href="https://mediasuite.clariah.nl/tool/single-search?queryId=38bf8a34-1b0c-4e25-a33c-724063787975">See subjects</a> in the Media Suite (scroll down to see 'Subject' on the lefthand side. Click on the three vertical dots for sorting options).</i>
...
<br>
<img class="link-icon" src="/favicon-32x32.png" alt="MS">
<i>
  See the subjects of
